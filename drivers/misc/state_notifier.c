...
bool state_notifier_enabled(void)
{
	bool is_state_notifier_enabled;

	if (enabled != 0)
		is_state_notifier_enabled = true;
	else
		is_state_notifier_enabled = false;

	return is_state_notifier_enabled;
}
