 ...
 *           (C) 2016-1017 Lonelyoneskatter <threesixoh.skater@yahoo.com>
 *
 ...
 * timer interval.
 */
#define DEFAULT_ABOVE_HISPEED_DELAY 30000
...
static unsigned long bimc_hispeed_freq = DEFAULT_BIMC_HISPEED_FREQ;
