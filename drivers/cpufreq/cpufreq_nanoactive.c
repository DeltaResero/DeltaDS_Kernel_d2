/*
 * drivers/cpufreq/cpufreq_nanoactive.c
 *
...
static unsigned long timer_rate = 10000;
...
static inline u64 get_cpu_idle_time(unsigned int cpu, u64 *wall)
{
	*wall = ktime_to_us(ktime_get());
	return ktime_to_us(get_idle_ktime(cpu));
}
...
MODULE_DESCRIPTION("'cpufreq_nanoactive' - A cpufreq governor for "
