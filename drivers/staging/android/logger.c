...
DEFINE_LOGGER_DEVICE(log_main, LOGGER_LOG_MAIN, 32*256)
DEFINE_LOGGER_DEVICE(log_events, LOGGER_LOG_EVENTS, 32*256)
DEFINE_LOGGER_DEVICE(log_radio, LOGGER_LOG_RADIO, 32*256)
DEFINE_LOGGER_DEVICE(log_system, LOGGER_LOG_SYSTEM, 32*256)
